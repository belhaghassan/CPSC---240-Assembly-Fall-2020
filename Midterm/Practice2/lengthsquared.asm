...
global lengthsquared                       ; Makes function callable from other linked files.
...
mov r12, rdi            ; array
mov r13, rsi            ; size of array

mov r14, 0              ; counter for iteration.
mov r15, 0              ; sum of the squared values in array.
