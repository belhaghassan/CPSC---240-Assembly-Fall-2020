...
long int result_code = -999;
	printf("%s", "\nThis is the CS 240 Midterm written by Bilal El-haghassan\n");
        
	result_code = manage();
	printf("%s%ld","\nThe main program received this number: ", result_code);
	printf("%s"," and will now return the operating system.\n\n");
	return 0;
}
